---
id: sfmc-personalisation-ideas
title: Ideas for SFMC Personalisation
sidebar_label: SFMC Personalisation
description: Here you can find all my SFMC Personalisation (Interaction Studio) IdeaExchange contributions. Let's make the change!
image: img/og/og-image-sfmc-personalisation-ideas.png
tags: [Marketing Cloud Personalisation, Ideas, Einstein]
---

import { LeadText } from '../../src/components/LeadText.js';
import { Button } from '../../src/components/Buttons.js';

<LeadText content="Here you can find all my SFMC Personalisation (Interaction Studio) IdeaExchange contributions. Let's make the change!" />
