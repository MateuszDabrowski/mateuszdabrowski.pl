...
MacOS. Windows if needed. Sorry Ubuntu, it wasn't working for me anymore.
...
- [Codeium](https://marketplace.visualstudio.com/items?itemName=Codeium.codeium): If you ever dreamt about the code that writes, documents and refactors itself, this is the extension you want. Creepy. Awesome. But creepy. Must have.
