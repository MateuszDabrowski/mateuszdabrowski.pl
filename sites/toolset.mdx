...
image: img/og/og-image-toolset.png
---
...
Privately - [Mermaid](http://mermaid.js.org). Lets me create diagrams with code and output them to a website in non-image format for better performance. You can find it in multiple articles, like [MMC Integration Patterns](/docs/salesforce/marketing-cloud-engagement/config/sfmc-mcc-integration-patterns/#single-business-unit-single-org-setup)
...
3. [PDF Expert](https://pdfexpert.com/) was the best PDF app you can have. Now it's still a good one, but keeps getting bloated.
4. [Cleanshot](https://cleanshot.com) makes capturing, annotating and sharing screenshots a breeze.
5. [Reeder](https://reederapp.com) - RSS is my favourite way of keeping up to speed with topics that are important to me. Reeder does it best.
