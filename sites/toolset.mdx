...
Still exploring to find the best mix, but currently I'm using Gemini for general use and research and Claude Code for vibe code experiments.

## Diagrams

In collaborative work settings - [Lucidchart](https://www.lucidchart.com/).

But for personal use, I prefer my own [Diagramforce](https://diagramforce.mateuszdabrowski.pl/). I'm mapping out architectures, processes and timelines. Diagramforce makes it fast and easy. No subscription needed.
