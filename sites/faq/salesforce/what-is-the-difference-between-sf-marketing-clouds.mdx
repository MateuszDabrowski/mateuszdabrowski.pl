...
Its main unique selling point - not only among the Salesforce Marketing Automation products, but also in the broader Marketing Automation landscape - is its __flexibility__ and __customisability__. It can be tailored to fit the specific needs of any business, no matter how complex.
...
It offers many drag-and-drop features that either require or at least greatly beneift from pro-code approach in Marketing Cloud Engagement. However, it is not as flexible or customisable as Marketing Cloud Engagement, and it lacks some advanced features.
...
The newest of the three products, Marketing Cloud, is a fresh take on Marketing Automation. Announced in 2024, it is built from scratch on the Data 360 (also known as Data Cloud in ancient early 2025 days) platform, leveraging its capabilities and integrations with other Salesforce products (especially the new hype champion - Agentforce).
...
However, if you are using Marketing Cloud Engagement, it is still the best option for real-time personalization. It is a mature and powerful platform with straightforward pricing that can deliver results.
...
As you can see, Salesforce Marketing Cloud product (and naming) landscape is changing a lot now. We are currently in a stretched transition period where old and new products coexist. What does it mean for you?
...
- __Easy Leads__: You don't have to go through the full sales funnel. Your past successful implementations of MCE & MCAE are the best leads for introducing the Next features.
- __New Audiences__: If you are focused only on Salesforce Marketing solutions, you can now tap new audiences that the fresh offerings target and extend your pipeline.

#### Implementation Challenges

On the other hand, it means that you will need to invest in learning.

- __Continuous Evolution__: The new products are still evolving. There will be a lot of changes and updates in the coming months and years - not just to the Marketing Cloud tools, but also to Data 360 and Agentforce 360. There will be a lot of relearning and replanning along with constant feed of new features and approaches.
- __New Stack__: It won't be easy. New products are built on Data 360 and Agentforce 360. Your marketing implementation teams will need to learn completely new skills to work with them.

The next few years will be a balancing act between leveraging your existing expertise for ongoing implementations and investing in new skills. But if you can do it, you will position yourself as a leader for the Next Marketing Cloud.
...
Don't stop at certification - go deeper. Every single new Marketing Cloud product will leverage this knowledge.

#### MCAE Specialists

If your specialty is Marketing Cloud Account Engagement, you have the advantage of already being familiar with the Salesforce CRM platform. However, the new Marketing Cloud is (somewhere) soon to replace MCAE (and is already offered for free to existing customers to facilitate this move).

You don't have much time to learn the new tool. Dive into Data 360 and Agentforce 360 to be ready for the change. Explore the new Marketing Cloud product, experiment with its features, and start building your expertise leveraging the free licence existing MCAE customers already have.
...
However, you should start learning the new Marketing Cloud as well. Marketing Cloud Engagement Plus licences are already here. They not only provide existing customers with access to the new product but also bring unique features based on the synergy between the two products.

It means that even if your MCE platform is still safe for years to come, you need MC Next (and Data 360, and Agentforce 360) skills to deliver full value.
...
If you are looking for Marketing Automation Platform and Salesforce offering looks interesting to you (for example because you are already using their CRM or needs extremely flexible and powerful platform), the [Marketing Automation Platforms](#marketing-automation-platforms) section should help you choose the right product for your needs.

The rule of thumb is:
- If you need complex and highly customisable solution, go for __Marketing Cloud Engagement__.
- If you need something simpler, B2B focused, with good support and maturity, go for __Marketing Cloud Account Engagement__.
- If you are Salesforce CRM (and - even better - Data 360) user and just need basic marketing capabilities with agentic support to minimise the effort, go for the new __Marketing Cloud__.

:::note You Should Know

This advice is valid for now, but will need an update in a year, max two with how fast the new Marketing Cloud product is evolving.
...
There is no migration solution as of now. You will need to plan and execute the move on your own. However, having both products available gives you the opportunity to do it gradually, testing and learning along the way. Don't wait for added pressure of a deadline - start checking it now and consier using it for new use cases to limit technical debt.

:::

#### With Marketing Cloud Engagement

If you are using Marketing Cloud Engagement, you are safe (for now). However, your team should start getting familiar with Data 360 and the new Marketing Cloud product. Marketing Cloud Engagement Plus licences are already here (and you will have it by the next renewal period at the latest).
