...
### Salesforce Marketing Automation Products
...
Marketing Cloud engagement is the oldest and most established of the three products. It is a robust and feature-rich platform that has been around for 25 years. It is designed for large enterprises and B2C companies with complex marketing needs.

It's main unqiue selling point - not only among the Salesforce Marketing Automation products, but also in the broader Marketing Automation landscape - is its flexibility and customisability. It can be tailored to fit the specific needs of any business, no matter how complex.

However, this flexibility comes at a cost - it can be challenging to set up and use, especially for non-technical users, and there are tons of (first party and third party) add-ons that bring various features and capabilities to the platform.




- Strong community and resources
- Can work as standalone or integrated with Salesforce CRM
- Large marketing teams with IT support

### Marketing Cloud Account Engagement (MCAE)

- B2B focused Marketing Automation platform
- Available as a part of Salesforce CRM
- Seamless integration with Salesforce CRM
- User-friendly for marketers
- Strong community and resources
- Soon to be replaced by Marketing Cloud on Core

- B2B focused features
- Large & medium businessnes
- Small to medium marketing teams

#### Marketing Cloud [on Core] (MC)
