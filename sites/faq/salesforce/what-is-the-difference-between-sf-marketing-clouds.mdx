...
This is also proven by the new Marketign Cloud Engagment Plus licences offering synergy between MCE and the new Marketing Cloud product.
...
The newest of the three products, simply called Marketing Cloud (known also as Marketing Cloud on Core, Marketing Cloud Growth, Marketing Cloud Advanced or Marketing Cloud Next) is a fresh take on Marketing Automation. Announced in 2024, it is built from scratch on the Data Cloud platform, leveraging its capabilities and integrations with other Salesforce products (especially the new hype champion - Agentforce).
