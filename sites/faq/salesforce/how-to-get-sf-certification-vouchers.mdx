...
Currently Salesforce is offering a free :product[Data Cloud]{as-written} Certification Voucher for employees of any Salesforce Partner Company that complete a 6 hour :product[Data Cloud]{as-written} training. Check details and register [here](https://cloud.mail.salesforce.com/partnerdatacloud).
