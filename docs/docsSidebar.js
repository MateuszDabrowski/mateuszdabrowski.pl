    ...
    docs: [
        ...
        },
        {
            ...
            link: {
                ...
                description: 'Marketing Cloud Personalization (Interaction Studio) is a cross-channel real-time hyper-personalisation engine in Salesforce Marketing Cloud. Behind that cool-looking description is a powerful tool that lets your company adapt every point of contact to each person. Neat!',
            ...
            items: [
                ...
                'interaction-studio/mcp-open-time-email',
                {
                    ...
                    link: {
                        ...
                        keywords: ['Marketing Cloud', 'Marketing Cloud Personalization', 'Interaction Studio', 'Personalisation', 'TypeScript'],
