...
## Final countdown
Let's talk about a simple solution you can implement on your landing page in just **ARTICLE COUNTER HERE**. A counter.
...
For example, did you know there is only **EVENT COUNTER HERE** left till 50th anniversary of the first moon landing?

``` html Sample countdown code for above line
<p id="counter">
    For example, did you know there is only
    <span class="days"></span> days
    <span class="hours"></span> hours
    <span class="minutes"></span> minutes and
    <span class="seconds"></span> seconds left
    till 50<sup>th</sup> anniversary
    of the first moonlanding?
</p>
...
To do this, make your marketing automation tool push a date value (in above mentioned ISO 8601 format) from the visitor data model right into var deadline JavaScript line. In Oracle Eloqua it would be a [field merge](https://docs.oracle.com/cloud/latest/marketingcs_gs/OMCAA/Help/FieldMerges/FieldMergeExamples.htm):

``` js
const deadline = new Date("Date_Field_Merge1").getTime();
```
