...
tags: [Interaction Studio, Personalisation, Data Management]
---
...
Interaction Studio (MCP) can pull [product, content and related catalog data](../is-catalog-architecture.mdx) from multiple sources and does it continuously. That's perfect when all works great, but debugging features are minimal once you see some data discrepancies.
...
1. [Vote for IdeaExchange](https://ideas.salesforce.com/s/idea/a0B8W00000NWbmJUAT/full-is-mcp-catalog-metadata-visibility) to make it perfect out-of-the-box.
...
While this solution can benefit Interaction Studio [Catalog Object](../is-catalog-architecture.mdx) debugging, there are a few significant limitations.
