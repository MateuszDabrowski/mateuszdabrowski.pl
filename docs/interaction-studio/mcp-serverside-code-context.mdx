...
`smartSearch()` can return more than 12 recommendations (it can bring back thousands), but as it returns whole Item details, it can impact performance. It might be helpful to filter the outcome just to the information required for your purpose.
