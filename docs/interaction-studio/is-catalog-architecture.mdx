...
-- | -- | -- | --
ID | String |  Unique identifier for each Item | ID can be reused in other Catalogs
Name  | String | Readable name of an Item | It will be displayed as main value across the UI. Required to recommend an Item
URL | String | Link to the Item | Required to recommend an Item
Image URL | String | Link used to display an Image of an Item | Required to recommend the Product
Description | String | Client-friendly description of an Item
Average Rating | Decimal | Average score of an Item based on all Ratings
