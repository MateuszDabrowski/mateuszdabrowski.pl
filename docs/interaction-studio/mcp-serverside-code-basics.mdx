...
Whether you are creating a Web, Serverside or Triggered Campaign Template in the Marketing Cloud Personalization (Interaction Studio), in each case you will start with the Serverside Code tab. It is true core of the platform responsible for delivering data-driven personalizations.
...
All above things are done within Serverside Code tab of the MC Personalization Template creation UI with TypeScript programming language and built-in functions. Don't worry if you don't know TypeScript - basic knowledge of modern JavaScript is enough to create good templates.
...
Run block has access to the context - triggering event details and MC Personalization data. It can also pull information configured in the properties by the marketer. With all of this you can use it to enrich and transform the data that will be returned by the campaign.
...
Here, I want to share a few of my favourite sources of MC Personalization Templates:
