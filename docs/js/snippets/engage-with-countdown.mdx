...
description: Start boosting conversion rates right now! There are many ways to engage customers, and urgency is the king among them. Build a JavaScript countdown timer for your landing pages, with counting options and dynamic content.
...
In :product[Salesforce Marketing Cloud]{of=mce as-written}, you can use either [AMPScript personalisation string](https://developer.salesforce.com/docs/atlas.en-us.noversion.mc-programmatic-content.meta/mc-programmatic-content/personalisationStringsAMPscript.htm) or SSJS personalisation string:
