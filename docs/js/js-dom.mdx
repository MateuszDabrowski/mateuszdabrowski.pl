...
1. [Tailor with Data](../js/js-snippet-tailor-with-data.mdx) - leverage DOM manipulation and personalisation strings to create dynamic experiences for your customers.
2. [Export, Import & Document SFMC Roles](./js-snippet-export-import-document-sfmc-roles.mdx) - Backup, clone and move cross-account the Salesforce Marketing Cloud roles. In seconds, thanks to DOM.