...
Everything discussed up to this point was nice, but not breathtaking. Time to change this and jump straight into the real reason it is worth to dive into the DOM. The ins and outs of manipulating it with methods.
