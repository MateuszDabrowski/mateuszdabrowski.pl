...
One of the key manipulation methods for marketing automation is adding events with `.addEventListener`. This method lets you perform some actions (a function) given a specific behaviour. In simpler words, you can tell the browser to execute some JavaScript function when the user for example clicks a button. Or moves the mouse out of the page to close it or change a tab.

You can add an event to any selector:
...
### Creating and replacing DOM elements
