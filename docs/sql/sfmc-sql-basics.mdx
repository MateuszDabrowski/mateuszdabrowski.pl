...
However, there is much to learn to unlock the full power of SQL in SFMC. Check out deep-dive docs on other SQL Statements ([`LIKE`](sfmc-sql-like)), [String](sfmc-sql-string-functions), [Date](sfmc-sql-date-functions), [Number](sfmc-sql-numeric-functions), [Conversion](sfmc-sql-conversion-functions) Functions and [SFMC System Data Views](sfmc-sql-system-data-views).
