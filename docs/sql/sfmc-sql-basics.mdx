...
To learn more about writing queries, check out deep-dive on [SQL Statements](/docs/sql/sfmc-sql-statements) and [SFMC Data Views](/docs/sql/sfmc-sql-system-data-views).
