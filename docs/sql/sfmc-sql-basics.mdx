...
However, there is much to learn to unlock the full power of SQL in SFMC. Check out deep-dive docs on other SQL Statements ([`LIKE`](sfmc-sql-like)) and [SFMC System Data Views](sfmc-sql-system-data-views).
