...
- [NULL](./sfmc-sql-null-functions.mdx) - just the first three paragraphs and [IS NULL](./sfmc-sql-null-functions.mdx#is-null) section.
...
### Level 3 - Dates, Comparisons, WHERE Shorthands
