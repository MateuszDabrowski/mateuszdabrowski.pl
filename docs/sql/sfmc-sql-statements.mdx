...
The simplest version of this statement is `SELECT *`, which targets all available columns from the source. It is not recommended approach. Bad for both readability and performance of your query. This is why [Query Studio](/docs/sql/sfmc-sql-basics#query-studio) does not support this shortcut.
...
3. Avoid Data Extensions spanning a cumulative field width greater than 4000 characters.
