...
The last line outputs `Freitag, 7. Februar 2020`. Neat for running it with [`CASE`](sfmc-sql-case) to change your short date into an extended date personalized on user language.
