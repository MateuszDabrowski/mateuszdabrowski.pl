...
title: SFMC SQL Case
sidebar_label: Case
description: When you have a problem with data then solve it with CASE statement. Empower your Marketing Cloud queries with SQL conditional logic.
...
<LeadText content='When you have a problem with data then solve it with CASE statement. Empower your Marketing Cloud queries with SQL conditional logic.' />
