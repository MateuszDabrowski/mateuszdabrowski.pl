...
There are few approaches related to comma placement, but putting them at the end of the line is easier for both writing and reading, as it follows natural language.
...
10. Use commas at the end of the line [🔗](#commas-placement)
...
14. When using `JOIN`, add meaningful aliases for Tables and prefix all Columns with them [🔗](#join-and-on)
