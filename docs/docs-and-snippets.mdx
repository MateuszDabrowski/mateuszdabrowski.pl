...
<Button
    link='./docs/category/sfmc-config/'
...
<Button
    link='./docs/category/sfmc-use-cases/'
    text='Read about SFMC Use Cases'
/>

## SFMC AppExchange

There are over 4000 solutions in Salesforce AppExchange with few dozens dedicated to Salesforce Marketing Cloud. Here I want to go through the most interesting ones and get a bit deeper into their value proposition.

<!-- - [SFMC AppExchange Overview](./appexchange/sfmc-appexchange-overview.mdx) -->

<Button
    link='./appexchange/sfmc-appexchange-overview'
    text='Read about SFMC AppExchange'
/>
