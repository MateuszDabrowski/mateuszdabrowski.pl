...
<a class="button button--outline button--lg button--primary col col--6 col--offset-3" href="./zen-of-sfmc">Read about Zen of SFMC</a>
...
<a class="button button--outline button--lg button--primary col col--6 col--offset-3" href="../docs/category/ssjs/">Read about SSJS</a>
...
<a class="button button--outline button--lg button--primary col col--6 col--offset-3" href="../docs/category/javascript/">Read about JavaScript</a>
...
<a class="button button--outline button--lg button--primary col col--6 col--offset-3" href="../docs/category/ampscript/">Read about AMPScript</a>
...
<a class="button button--outline button--lg button--primary col col--6 col--offset-3" href="../docs/category/sfmc-sql/">Read about SFMC SQL</a>
...
<a class="button button--outline button--lg button--primary col col--6 col--offset-3" href="../docs/category/sfmc-config/">Read about SFMC Config</a>
...
<a class="button button--outline button--lg button--primary col col--6 col--offset-3" href="../docs/category/sfmc-use-cases/">Read about SFMC Config</a>
