...
- [AMPScript in SSJS](./ssjs/snippets/ssjs-snippet-ampscript-in-ssjs.mdx)
- [MobileConnect Phone Change](./ssjs/snippets/ssjs-snippet-mobileconnect-phone-change.mdx)
- [SSJS Script Template](./ssjs/snippets/ssjs-snippet-ssjs-script-template.mdx)
...
- [Tailor with Data](./js/snippets/js-snippet-tailor-with-data.mdx)
- [Engage with Countdown](./js/snippets/js-snippet-engage-with-countdown.mdx)
- [Export, Import & Document Roles in Salesforce Marketing Cloud](./js/snippets/js-snippet-export-import-document-sfmc-roles.mdx)
...
- [Debugging Email Sends](./sql/snippets/sfmc-sql-snippet-debugging-email-sends.mdx)
- [Debugging Value Length](./sql/snippets/sfmc-sql-snippet-debugging-value-length.mdx)
