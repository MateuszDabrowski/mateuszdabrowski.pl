...
- [AMPScript in SSJS](./ssjs/snippets/ampscript-in-ssjs.mdx)
- [MobileConnect Phone Change](./ssjs/snippets/ssjs-mobileconnect-phone-change.mdx)
- [SSJS Script Template](./ssjs/snippets/ssjs-script-template.mdx)
- [Solve with Cloud Page Apps](./ssjs/snippets/sfmc-cloud-page-apps.mdx)
...
- [Tailor with Data](./js/snippets/tailor-with-data.mdx)
- [Engage with Countdown](./js/snippets/engage-with-countdown.mdx)
- [Export, Import & Document Roles in Salesforce Marketing Cloud](./js/snippets/export-import-document-sfmc-roles.mdx)
...
- [Debugging Email Sends](./sql/snippets/sfmc-sql-debugging-email-sends.mdx)
- [Debugging Value Length](./sql/snippets/sfmc-sql-debugging-value-length.mdx)
...
{/* - [Licence Limits](./config/sfmc-licence-limits.mdx) */}
- [System Data Views](./config/sfmc-system-data-views.mdx)
- [Mobile Connect Data Views](./config/sfmc-mobile-connect-data-views.mdx)
- [MCC Integration Patterns](./config/sfmc-mcc-integration-patterns.mdx)
- [Contact Deletion Process](./config/sfmc-contact-deletion.mdx)
- [Enhanced Send Log](./config/sfmc-enhanced-send-log.mdx)
- [Behavioral Triggers](./config/sfmc-behavioral-triggers.mdx)
- [Power of Code Resources](./config/sfmc-code-resource.mdx)
- [AppExchange Solutions](./config/sfmc-appexchange-solutions.mdx)
- [Features On Demand](./config/sfmc-features-on-demand.mdx)
...
- [Catalog Objects Architeture](./interaction-studio/mcp-catalog-architecture.mdx)
- [Open Time Email Template](./interaction-studio/mcp-open-time-email.mdx)
- [Serverside Code Basics](./interaction-studio/mcp-serverside-code-basics.mdx)
- [Serverside Code Properties](./interaction-studio/mcp-serverside-code-properties.mdx)
- [Serverside Code Context](./interaction-studio/mcp-serverside-code-context.mdx)

### MC Personalization Snippets

- [Catalog ETL Metadata Viewer](./interaction-studio/snippets/mcp-catalog-etl-metadata-viewer.mdx)
