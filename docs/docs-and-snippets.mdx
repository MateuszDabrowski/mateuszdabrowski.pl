...
Interaction Studio (Salesforce Marketing Cloud Personalization) is a cross-channel real-time hyper-personalisation engine in Salesforce Marketing Cloud. Behind that cool-looking description is a powerful tool that lets your company adapt every point of contact to each person. Neat!

### Interaction Studio Documentation

- [Catalog Objects Architeture](./interaction-studio/is-catalog-architecture.mdx)
- [Serverside Code in Campaign Templates](./interaction-studio/is-serverside-code-in-campaigns.mdx)
- [Open Time Email Template](./interaction-studio/is-open-time-email.mdx)

### Interaction Studio Snippets

- [Catalog ETL Metadata Viewer](./interaction-studio/snippets/is-catalog-etl-metadata-viewer.mdx)
