...
So the best recommendation is to just decide on one style - whichever it will be - across the whole team and stay consistent.

I decided to use mixed approach for the sake of readability. It might not be as simple as focusing on just one letter case format for the whole code, but it improves experience of working with longer and more complex scripts a lot.
