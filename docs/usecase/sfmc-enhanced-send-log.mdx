...
If your send was not delivered, but you can see it in the Send Log without any `ErrorCode`, leverage [Email Sends Debugging Query](../sql/snippets/sfmc-sql-snippet-debugging-email-sends.mdx) to learn what happened with the message.
