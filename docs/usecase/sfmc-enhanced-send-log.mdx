...
Unfortunately, it currently does not support Journey Builder Sends. Learn more and vote for a fix [here](../../../sites/ideas/sfmc-ideas#_datasourcename-for-entry-data-extension-in-journey-builder).
