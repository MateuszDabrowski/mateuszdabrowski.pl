...
sidebar_label: Solve with Cloud Page Apps
...
tags: [SSJS, AMPScript, Snippet, Cloud Page]
---
...
<script runat='server'>
    ...
    3.2.4. Upsert Logging Data Extension
    3.2.5. Handle authentication error
    ...
    */
    ...
    /* ---------------------- 3.2. Authentication ---------------------------- */
        ...
        if (response.StatusCode == 200) {
            ...
            /* 3.2.4. Upsert Logging Data Extensions */
            Platform.Function.UpsertData(authDE, ['session'], [state], ['appName', 'token', 'tokenExpire'], [appName, accessToken, tokenExpire]);
        /* 3.2.5. Handle authentication error */
        } else {
...
1. __Logging Data Extensions__
    ...
    2. In Content Builder or Email Studio create an [Error Logging Data Extension](../ssjs/debugging-ssjs.mdx#logging-to-data-extension).
