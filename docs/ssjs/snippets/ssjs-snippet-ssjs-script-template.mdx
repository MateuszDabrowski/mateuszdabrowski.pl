...
In many cross-cloud scenarios I also use [AMPScript runner](./ssjs-snippet-ampscript-in-ssjs.mdx), but as it is more use case specific solution, I don't keep it in base template.
