...
To make your code better, don't stop at just the code. Leverage comments to its full potential. Context, logic and caveats description will improve the experience for everyone - including you after few weeks.

Whenever you are building longer SSJS code, I recommend using at least three types of comments - pseudo-code, section and documentation. For short scripts, the last one will be enough.

### 1. Table of Contents Comment

The first type of comment should be used in the very top of your longer scripts is table of contents comment. This one will be your best friend during whole lifecycle of your script.
...
For complex scripts it might be good idea to create few different levels of such comments. I use upper case with dashes for first level, title case with dashes for second level and just title case for third level of comments
...
/* 3.2.1. Upsert Logging Data Extensions */
```
...
Looking for more Marketing Cloud style? Check out my [SFMC SQL Style Guide](../sql/sfmc-sql-style-guide.mdx).