...
Create Automation with Query Activity that will take data from your technical Send Log and [System Data Views](./sfmc-system-data-views.mdx) to populate your Enhanced Send Log DE with actionable data.
