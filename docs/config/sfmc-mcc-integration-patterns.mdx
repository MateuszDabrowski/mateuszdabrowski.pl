...
1. If you have full copy sandbox integrated to Dev & Test Business Unit, it can heavily impact your Contact Count licence limits, as each Contact, Lead and User will have different SFID and due to that counted separately.
2. All Subscribers list is global, so make sure to use Filters to limit visibility of your test data on other Business Untis and vice versa.