...
It is perfect if only you are ok with all Business Units having the same configuration and filters applied. It provides simplicity and unlimited Business Unit scaling.
...
It might be your choice (but better consider other options) if you have:
