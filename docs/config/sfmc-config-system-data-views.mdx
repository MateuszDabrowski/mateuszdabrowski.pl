...
Another must have is awesome [System Data Views Database Schema](https://github.com/samteezy/sfmc_schema) made by [Sam Tylor](https://www.linkedin.com/in/samgtaylor). Ton of info about specific value lengths and ready-to-use snippets to prepare whole database structure for backup.
