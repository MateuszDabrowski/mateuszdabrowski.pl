...
<Tabs
    defaultValue='fields'
    values={[
        {label: '_Subscribers Fields', value: 'fields'},
        {label: '_Subscribers SQL Query', value: 'sql'},
    ]}
>
...
<Tabs
    defaultValue='fields'
    values={[
        {label: '_EnterpriseAttribute Fields', value: 'fields'},
        {label: '_EnterpriseAttribute SQL Query', value: 'sql'},
    ]}
>
<TabItem value='fields'>
...
<Tabs
    defaultValue='fields'
    values={[
        {label: '_Job Fields', value: 'fields'},
        {label: '_Job SQL Query', value: 'sql'},
    ]}
>
<TabItem value='fields'>
...
<Tabs
    defaultValue='fields'
    values={[
        {label: '_Sent Fields', value: 'fields'},
        {label: '_Sent SQL Query', value: 'sql'},
    ]}
>
<TabItem value='fields'>
...
<Tabs
    defaultValue='fields'
    values={[
        {label: '_Open Fields', value: 'fields'},
        {label: '_Open SQL Query', value: 'sql'},
    ]}
>
<TabItem value='fields'>
...
<Tabs
    defaultValue='fields'
    values={[
        {label: '_Click Fields', value: 'fields'},
        {label: '_Click SQL Query', value: 'sql'},
    ]}
>
<TabItem value='fields'>
...
<Tabs
    defaultValue='fields'
    values={[
        {label: '_Bounce Fields', value: 'fields'},
        {label: '_Bounce SQL Query', value: 'sql'},
    ]}
>
<TabItem value='fields'>
...
<Tabs
    defaultValue='fields'
    values={[
        {label: '_Complaint Fields', value: 'fields'},
        {label: '_Complaint SQL Query', value: 'sql'},
    ]}
>
<TabItem value='fields'>
...
<Tabs
    defaultValue='fields'
    values={[
        {label: '_Unsubscribe Fields', value: 'fields'},
        {label: '_Unsubscribe SQL Query', value: 'sql'},
    ]}
>
<TabItem value='fields'>
...
<Tabs
    defaultValue='fields'
    values={[
        {label: '_BusinessUnitUnsubscribes Fields', value: 'fields'},
        {label: '_BusinessUnitUnsubscribes SQL Query', value: 'sql'},
    ]}
>
<TabItem value='fields'>
...
<Tabs
    defaultValue='fields'
    values={[
        {label: '_ListSubscribers Fields', value: 'fields'},
        {label: '_ListSubscribers SQL Query', value: 'sql'},
    ]}
>
<TabItem value='fields'>
...
<Tabs
    defaultValue='fields'
    values={[
        {label: '_MobileAddress Fields', value: 'fields'},
        {label: '_MobileAddress SQL Query', value: 'sql'},
    ]}
>
<TabItem value='fields'>
...
<Tabs
    defaultValue='fields'
    values={[
        {label: '_MobileSubscription Fields', value: 'fields'},
        {label: '_MobileSubscription SQL Query', value: 'sql'},
    ]}
>
<TabItem value='fields'>
...
<Tabs
    defaultValue='fields'
    values={[
        {label: '_SubscriberSMS Fields', value: 'fields'},
        {label: '_SubscriberSMS SQL Query', value: 'sql'},
    ]}
>
<TabItem value='fields'>
...
<Tabs
    defaultValue='fields'
    values={[
        {label: '_SMSSubscriptionLog Fields', value: 'fields'},
        {label: '_SMSSubscriptionLog SQL Query', value: 'sql'},
    ]}
>
<TabItem value='fields'>
...
<Tabs
    defaultValue='fields'
    values={[
        {label: '_SMSMessageTracking Fields', value: 'fields'},
        {label: '_SMSMessageTracking SQL Query', value: 'sql'},
    ]}
>
<TabItem value='fields'>
...
<Tabs
    defaultValue='fields'
    values={[
        {label: '_UndeliverableSMS Fields', value: 'fields'},
        {label: '_UndeliverableSMS SQL Query', value: 'sql'},
    ]}
>
<TabItem value='fields'>
...
<Tabs
    defaultValue='fields'
    values={[
        {label: '_Journey Fields', value: 'fields'},
        {label: '_Journey SQL Query', value: 'sql'},
    ]}
>
<TabItem value='fields'>
...
<Tabs
    defaultValue='fields'
    values={[
        {label: '_JourneyActivity Fields', value: 'fields'},
        {label: '_JourneyActivity SQL Query', value: 'sql'},
    ]}
>
<TabItem value='fields'>
...
<Tabs
    defaultValue='fields'
    values={[
        {label: '_AutomationInstance Fields', value: 'fields'},
        {label: '_AutomationInstance SQL Query', value: 'sql'},
    ]}
>
<TabItem value='fields'>
...
AutomationInstanceEndTime_UTC | Automation run end datetime in UTC timezone. Null if not yet ended | Date | X
...
`_AutomationInstance` Data View shows data limited to a specific Business Unit. Your parent Business Unit has access to [`_Sent`](#_sent), [`_Open`](#_open), [`_Click`](#_click) and other data from all Business Units, but this is not the case with `_AutomationInstance`. You can query only those Journey Activities that were created in the Business Unit where you execute your SQL snippet.
...
`_AutomationActivityInstance` Data View shows data limited to a specific Business Unit. Your parent Business Unit has access to [`_Sent`](#_sent), [`_Open`](#_open), [`_Click`](#_click) and other data from all Business Units, but this is not the case with `_AutomationActivityInstance`. You can query only those Journey Activities that were created in the Business Unit where you execute your SQL snippet.
