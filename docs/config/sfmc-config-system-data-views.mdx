...
Be sure to check the awesome [Data Views relationship diagram](https://svgshare.com/i/TeR.svg) created by [Zuzanna Jarczyńska](https://sfmarketing.cloud). It will for sure help you with multi-view [`JOIN`s](../sql/sfmc-sql-join.mdx).
...
ContactStatus | Tell you whether the contact is still in the Journey (`Active` or `Exited`) | Text
