...
2. Key limitation of `_AutomationInstance` is that it starts outputting information about automation execution 24 hours after the automation instance was created. If you need real-time information about Automation Studio status, you will still need an API approach. But for not that urget use cases this new option will be much more performant.
...
2. Key limitation of `_AutomationActivityInstance` is that it starts showing information about activity execution 24 hours after the automation instance was created.
