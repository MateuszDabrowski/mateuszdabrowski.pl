...
3. Do not use User Interface editor in MobileConnect Demographics part of Contact view for editing data in this Data View. It is broken and overwrites all connected Mobile Numbers with a change made to just one. However, the changes are possible with SSJS - including ContactID and MobileNumber changes and limited merging. This is the biggest selling point of this Data View.
...
Name | Description | Data Type | Nullable
-- | -- | -- | --
MobileMessageTrackingID | Unique ID for tracking information related to the sent message | Number |
EID | Enterprise ID number for the sender | Number | X |
MID | Member ID | Number | X |
Mobile | Mobile number for the subscriber | v Phone |
MessageID | Mobile message ID | Number |
KeywordID | Unique identifier for the keyword | Text | X |
CodeID | Unique identifier for the SMS code | Text | X |
