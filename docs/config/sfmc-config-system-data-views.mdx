...
Be sure to check the excellent [System Tables relationship diagram](https://dbdiagram.io/d/5ff259ed80d742080a34e3c3) created by [Cameron Roberts](https://cameronrobert.com.au). It will for sure help you with multi-view [`JOIN`s](../sql/sfmc-sql-join.mdx).
