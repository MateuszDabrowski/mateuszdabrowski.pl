...
Not all solutions are available by default - some require a support ticket to be enabled. Check out my [list of features on-demand](./sfmc-features-on-demand.mdx) to see if there is anything hidden that might fulfil your requirements.
...
While the list might look like a hard pass for custom solutions, there is a place for them. Especially on the ends of the spectrum. Simple, but lifesaving micro solutions ([Cloud Page Apps](../ssjs/snippets/sfmc-cloud-page-apps.mdx), [Code Resources](./sfmc-code-resource.mdx)) or custom behemoths aligned to all non-negotiable quirks and features of your internal processes.
