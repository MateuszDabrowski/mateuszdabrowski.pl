...
Be sure to check the excellent [System Tables relationship diagram](https://dataviews.io) created by [Zuzanna Jarczyńska](https://sfmarketing.cloud/author/zjarczynska/). It will for sure help you with multi-view [`JOIN`s](../sql/sfmc-sql-join.mdx).
