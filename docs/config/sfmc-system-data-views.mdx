...
Learn more about Mobile Connect [SMS Data Views here](./sfmc-mobile-connect-data-views.mdx).
...
2. You can also connect it to SMS channel using [_SMSMessageTracking](./sfmc-mobile-connect-data-views.mdx#_smsmessagetracking) Data View by making a [`JOIN`](../sql/sfmc-sql-join.mdx) `ON journey.VersionID = smsTracking.JBDefinitionID`.
...
2. You can also connect it to SMS channel using [_SMSMessageTracking](./sfmc-mobile-connect-data-views.mdx#_smsmessagetracking) Data View by making a [`JOIN`](../sql/sfmc-sql-join.mdx) `ON journeyActivity.ActivityID = smsTracking.JBActivityID`.
