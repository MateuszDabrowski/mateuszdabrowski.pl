...
7. You can also leverage `JobID` field to [`JOIN`](../sql/sfmc-sql-join.mdx) your email sending activities directly with [`_Job`](#_job) and pull send-specific information from engagement Data Views.
