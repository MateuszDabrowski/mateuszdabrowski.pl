...
During Behavioral Trigger implementation there are at least three key phases when you might need to debug your solution. And as you will be merging multiple systems and working on time-bound data using still fresh feature, possibility to look behind the curtain will be crucial. Thankfully, there is few options that we can use.

### Debugging Collect.js

First thing to check is your Collect.js implementation.