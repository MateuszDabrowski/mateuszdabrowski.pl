...
<Tabs
    ...
    values={[
        {label: 'Snippet Highlights', value: 'highlights'},
        {label: 'Full Content Block', value: 'block'},
    ]}
>
<TabItem value='highlights'>

```html title="Sample code with my test configuration"
<!--
AMPScript responsible for pulling the data from Abandoned Engagement Data Extension.
If you want to use multiple different Behavioral Trigger scenarios, you can do a Lookup here to point into specific Data Extension.
-->
%%[
