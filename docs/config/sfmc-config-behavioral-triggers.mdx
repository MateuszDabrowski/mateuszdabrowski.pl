...
The current version of Behavioral Trigger Content Block is not rendering correctly on Yahoo, AOL and Windows Outlook. Learn more [here](../../../sites/ideas/sfmc-ideas#behavioral-trigger-content-block-rendering-on-yahoo-aol-windows-outlook).
