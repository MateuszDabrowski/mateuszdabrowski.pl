...
With April 2021 Marketing Cloud Release the Streaming Updates using Collect.js will be deprecated. The way forward will be Streaming Updates via API. Read more [here](https://help.salesforce.com/articleView?id=sf.mc_rn_april_2021_collect_tracking_code_streaming.htm&type=5).

As existing implementation will be available for some time still, I'm keeping this section until the solution will be fully killed.
