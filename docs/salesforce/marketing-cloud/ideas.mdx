...
:product[Data 360]/Semantic Model reports let you build a Row-Level Formula field - say, `Is_Hard_Bounce` - and give it a clear, readable Column Name. That name is what shows up everywhere in the report builder: the Outline pane, the column header, and the Fields panel's own "Row-Level Formulas" folder.
