...
I've filed an [Idea](/sites/ideas/salesforce/marketing-cloud-ideas.mdx#reference-row-level-formula-fields-by-their-name-in-summary-formulas) asking Salesforce to let Summary Formulas address a field by name instead, to make our life a little bit easier.
