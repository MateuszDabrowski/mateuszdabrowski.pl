...
I have heard mixed feedback on whether starting stright from a Dedicated IP is possible. Salesforce's own guidance is that you can't request a dedicated IP, and that the platform automatically assigns one when your volume exceeds the threshold. However, some customers report being able to request a dedicated IP as a starting point. If you have a strong use case, try your luck with the account team.
