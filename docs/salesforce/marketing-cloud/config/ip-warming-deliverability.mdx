...
Salesforce's own deliverability guidance, published for the whole Marketing Cloud family, is worth a read alongside this article - it covers related topics this piece doesn't: CAPTCHA/bot protection on signup forms, concrete spam-filter content triggers, named reputation-checking tools, and per-product hard-bounce removal mechanics.
