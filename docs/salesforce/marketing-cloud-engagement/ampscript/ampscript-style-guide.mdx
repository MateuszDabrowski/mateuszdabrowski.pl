...
description: Script with style. Readable code is a few rules & best practices away. Naming, letter case, indentation and comment rules for AMPScript in Marketing Cloud Engagement.
image: img/og/og-image-sf-mce-ampscript-style-guide.png
tags: [Marketing Cloud Engagement, AMPScript, Style Guide, Best Practice]
...
First things first: this Salesforce :product[Marketing Cloud Engagement] AMPScript style guide is highly subjective. You may use it as it is, implement only some parts of it, or ignore it altogether. There are only two rules that I believe are a must-have:
...
- [:product[MCE] SSJS Style Guide](/docs/salesforce/marketing-cloud-engagement/ssjs/ssjs-style-guide.mdx)
