...
tags: [Marketing Cloud Engagement, SSJS, SMS, Snippet]
...
There is a lot to like about the Salesforce :product[Marketing Cloud Engagement] Mobile Connect, but Contact management is not the one.
...
So what you can do? Leverage the [`_MobileAddress` Data View](/docs/salesforce/marketing-cloud-engagement/config/mobile-connect-data-views.mdx#_mobileaddress) along with simple SSJS snippet and force :product[MCE] to do what you want it to do.
...
- Your client opted-in for Keyword using SMS. It created a Contact with the phone number as Contact Key. Later your CRM pushed this contact to :product[MCE] with proper Contact Key. Merge it to have the engagement data adequately allocated.
