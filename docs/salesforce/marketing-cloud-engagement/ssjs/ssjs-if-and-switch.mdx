...
description: Deep dive into the two pillars of SSJS flow control. If statements, ternary, short-circuiting and switch in Marketing Cloud Engagement SSJS.
image: img/og/og-image-sf-mce-ssjs-if-and-switch.png
tags: [Marketing Cloud Engagement, SSJS]
...
Ternaries are not limited to variables and strings. They can also run functions or [debugging](/docs/salesforce/marketing-cloud-engagement/ssjs/debugging-ssjs.mdx#debugging-variable):
