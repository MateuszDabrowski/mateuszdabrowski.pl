...
image: img/og/og-image-sf-mce-ssjs-debugging-and-error-handling.png
tags: [Salesforce, Marketing Cloud Engagement, Marketing Automation, SSJS, Debugging, Cloud Page, Email]
---
...
When you start working with programmatic languages in Salesforce Marketing Cloud Engagement, you will quickly become close friends with the Error 500 page. And if you beat it and go forward with the code and official documentation, you will fall in love with unexpected errors in functions and API responses. How to survive those?
...
- [Code Resources](/docs/salesforce/marketing-cloud-engagement/config/code-resource.mdx) (Web Studio -> Content Builder)
...
When I want to go around those issues, I work in [JSON Code Resource](/docs/salesforce/marketing-cloud-engagement/config/code-resource.mdx) (in the past stored in Web Studio, now in Content Builder). It generates a link you can use to check whether everything works, just like a Cloud Page. However, page views are free. There is also no preview allowing for a faster save-reload cycle.
...
Alternatively use [ternary](/docs/salesforce/marketing-cloud-engagement/ssjs/ssjs-if-and-switch.mdx#ternary) to cover all scenarios:
