---
id: marketing-cloud-engagement-ideas
title: Marketing Cloud Engagement Ideas
sidebar_label: Marketing Cloud Engagement
...
tags: [Salesforce, Marketing Cloud Engagement]
---
...
2. __Solution Deluxe__: On top of the above solution, MCE should consider the Parameter Management to allow for a mix of global UTM's from Web Analytics Connector and local from the new text box in Behavioral Trigger Content Block configuration.
