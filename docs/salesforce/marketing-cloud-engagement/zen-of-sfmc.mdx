...
Read more on using comments in [SSJS](/docs/salesforce/marketing-cloud-engagement/ssjs/ssjs-style-guide.mdx#comments) and [AMPScript](./ampscript/ampscript-style-guide.mdx#comments).
