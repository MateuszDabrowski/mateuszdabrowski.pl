...
Check my Style Guides for [AMPScript](/docs/salesforce/marketing-cloud-engagement/ssjs/ssjs-style-guide.mdx), [SQL](/docs/salesforce/marketing-cloud-engagement/sql/sql-style-guide.mdx) to see more guides on making your code beautiful.
...
I have already written a lot about readability of Marketing Cloud programmatic langauges: [AMPScript](/docs/salesforce/marketing-cloud-engagement/ssjs/ssjs-style-guide.mdx), [SQL](/docs/salesforce/marketing-cloud-engagement/sql/sql-style-guide.mdx).
...
Looking for more examples of good naming? Check Style Guide recommendations for [AMPScript](/docs/salesforce/marketing-cloud-engagement/ssjs/ssjs-style-guide.mdx#naming-convention) and [SQL](/docs/salesforce/marketing-cloud-engagement/sql/sql-style-guide.mdx#explicit-vs-implicit).
