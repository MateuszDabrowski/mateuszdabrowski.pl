...
If you are using Cloud Pages for form handling or redirects - switch to [Code Resources](/docs/salesforce/marketing-cloud-engagement/config/webinars/sfmc-webinar-architecting-web-solutions.mdx).
