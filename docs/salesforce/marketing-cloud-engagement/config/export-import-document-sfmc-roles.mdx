---
id: export-import-document-MCE-roles
title: Export, Import & Document MCE Roles
sidebar_label: Export, Import & Document MCE Roles
description: Backup, clone, and move cross-account the Salesforce Marketing Cloud Engagement roles. In seconds.
...
<LeadText content="Backup, clone, and move cross-account the Salesforce Marketing Cloud Engagement roles. In seconds." />
...
As the default System Roles permissions in Salesforce Marketing Cloud can be edited freely and [currently there is no easy way to revert those changes](/sites/ideas/salesforce/marketing-cloud-engagement-ideas/#restore-default-permissions-for-sfmc-standard-system-roles), I created a backup repository for you with all out-of-the-box configurations.
