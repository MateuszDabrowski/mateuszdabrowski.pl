---
id: mce-account-architecture
title: MCE Account Architecture
sidebar_label: Account Architecture
description: Learn how to structure your Marketing Cloud Engagement account to make the most of the Business Units, Marketing Cloud Connect and deliverability features.
image: img/og/og-image-webinar-sf-mce-account-architecture.png
tags: [Webinar, Marketing Cloud Engagement, Setup, Deliverability, Business Units]
...
<LeadText content="Learn how to structure your Marketing Cloud Engagement account to make the most of the Business Units, Marketing Cloud Connect and deliverability features." />
...
<YouTube videoId="dRxcbwIA1K0" title="Marketing Cloud Engagement Account Architecture Webinar Recording" />
...
While one SF Org can have only one integration to a single :product[MCE] Account, you can leverage [more than one Integration User on the Salesforce side](https://help.salesforce.com/s/articleView?id=000381081&type=1) for that connection. Doing so provides a few significant benefits:
...
3. While you still cannot control the [Synchronized DEs visibility](https://youtu.be/dRxcbwIA1K0?t=2173) of :product[MCE] Users, you can control which Objects and Records are being synchronized to each Business Unit by applying appropriate Permissions to each SF Integration User. It enables use cases like syncing different Contact Record Types to each Business Unit.
