...
tags: [Webinar, Marketing Cloud Engagement, Best Practice, AMPScript, CRM, Data Management, Integration, Journey]
...
The actual logic for records that are not yet in the Salesforce :product[Marketing Cloud Engagement] is a bit more complex:
...
True | True | False | __Not added to :product[MCE]__
True | False | True | __Not added to :product[MCE]__
