...
tags: [Salesforce, Marketing Cloud Engagement, Marketing Automation, Configuration, SQL, Analytics, Data Extensions, SMS]
---
...
`_SubscriberSMS` Data View is a __legacy table__. It is neither supported nor updated, and you won't have records there. MCE used it in pre-MobileConnect times, so I do not recommend using it for any projects.
