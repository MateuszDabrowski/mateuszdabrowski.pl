...
tags: [Salesforce, Marketing Cloud Engagement, Marketing Automation, Configuration, Email, Journey, Personalisation, Behavioral Triggers, Einstein]
---
...
Behavioral Triggers are a solution for smoothly moving abandoned engagement data from your e-commerce to Salesforce Marketing Cloud Engagement. They enable powerful win-back communication you can create with minimal technical knowledge in express time.
...
The first data layer you need to push contains, again, the MID of the Business Unit. Just as with the [Collect Code Script](#collect-code-script), be sure to change the `MID` to your MCE BU's actual ID.
...
The current version of Behavioral Trigger Content Block is not rendering correctly on Yahoo, AOL and Windows Outlook. Learn more [here](/sites/ideas/salesforce/marketing-cloud-engagement-ideas/#behavioral-trigger-content-block-rendering-on-yahoo-aol-windows-outlook).
