...
tags: [Salesforce, Marketing Cloud Engagement, Marketing Automation, SQL, Snippet, Data Extensions, Debugging]
---
...
Working with Marketing Cloud Engagement (MCE) (or any other Marketing Automation Platform) is always the dance between optimisation and flexibility. It is easily visible when working with MCE Data Extensions.
