...
If you need more, there is a trick reported by [Markus Slabina](/docs/salesforce/marketing-cloud-engagement/sql/sql-conversion-functions.mdx#data-types) field that allows absurdly long data to be stored.
...
Let's change the `LEN(/docs/salesforce/marketing-cloud-engagement/sql/sql-select.mdx) statement part to something a bit more interesting:
