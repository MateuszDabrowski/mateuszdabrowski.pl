...
And if you encounter systemic issue and wonder which type of Subscriber Key should be kept as the primary, you can check which types are being used for email sends. This might help you decide which duplicates to keep and which ones to remove:
