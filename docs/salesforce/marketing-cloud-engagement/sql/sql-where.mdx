...
With dates, you will frequently want to use a bit more complex structure for the comparison to work correctly. In this case, we are converting the `DateJoined` value to a simple date (/docs/salesforce/marketing-cloud-engagement/sql/sql-date-functions.mdx).
