...
You can also leverage [style codes](/docs/salesforce/marketing-cloud-engagement/sql/sql-date-functions.mdx#format-with-dates) function on top.
...
Just as with data types - there are many style codes available. Here I will cover just the most popular ones (/docs/salesforce/marketing-cloud-engagement/sql/sql-date-functions.mdx#custom-date-formats)):
