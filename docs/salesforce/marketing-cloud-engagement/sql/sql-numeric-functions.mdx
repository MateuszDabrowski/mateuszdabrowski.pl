...
There are nine standard formats available, but only a few are useful on a day-to-day basis in :product[MCE]:
...
Just as highlighted in the table header - the examples are for the :product[MCE] default US culture formating.
