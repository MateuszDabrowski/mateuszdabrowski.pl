...
With the basics of Serverside Code processing, you are ready to start coding. Next step - build MCP Campaign Template inputs with [Serverside Code Properties](/docs/salesforce/marketing-cloud-personalization/serverside-code-properties/).
...
1. My [MCP Campaign Templates and code snippets](/docs/category/salesforce/marketing-cloud-personalization/snippets/)
