...
tags: [Salesforce, Marketing Cloud Personalization, Personalization, Interaction Studio, TypeScript, Data Management]
---
...
Additionally, it's a great way to showcase some [MCP Serverside Code](/docs/salesforce/marketing-cloud-personalization/serverside-code-basics.mdx) approaches that can be useful for building standard campaign templates.
...
While this solution can benefit [MCP Catalog Object](/docs/salesforce/marketing-cloud-personalization/catalog-architecture.mdx) debugging, there are a few significant limitations.
