...
- Doesn't support [drill-down Category hierarchy](/sites/ideas/salesforce/marketing-cloud-personalization-ideas#full-mcp-category-hierarchy-support-for-etl) in the UI<sup>[*](#category-catalog-unique-attributes)</sup>.
...
List Price | Decimal | Full sticker price of the product | Useful for price drop personalization and Product Price Reduction Triggered Campaigns. Unfortunately, there is no Price Reduction Recipe [yet](/sites/ideas/salesforce/marketing-cloud-personalization-ideas#price-reduction-ingredient-in-einstein-recipes).
...
That's dirty, but there is currently no other option for that. I created an [Idea to change that](/sites/ideas/salesforce/marketing-cloud-personalization-ideas#full-mcp-catalog-export).
