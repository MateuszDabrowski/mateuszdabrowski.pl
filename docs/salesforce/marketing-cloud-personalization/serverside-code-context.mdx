...
Requires either nothing or start/end data boundary and returns... nothing. At least I couldn't get it to work with the [OTE Campaign](/docs/salesforce/marketing-cloud-personalization/open-time-email.mdx) data. It may leverage the barely working [External Email Campaign ETL](/sites/ideas/mc-personalization-ideas#external-email-campaign-etl-send-segmentation).
