...
Just as you can add a complex property to a field, you can also create a complex property using complex properties. While it can again give you all the benefits mentioned here, be careful not to go overboard. Deep nesting is more challenging to understand and use. There is no perfect rule, but check out [Simple/Complex recommendations in Zen of SFMC](docs/salesforce/marketing-cloud-engagement/zen-of-sfmc/#simple-is-better-than-complex).
